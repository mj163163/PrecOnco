...
pheatmap(mat,fontsize_col = 8,col= rev(hcl.colors(20, "Spectral")),angle_col = 45,fontsize_row = 10,cluster_cols = T,annotation_colors = ann_colors,cluster_rows=F,annotation_col = labels,annotation_names_row = F,clustering_distance_rows = "correlation",
         clustering_distance_cols = "correlation" ,show_rownames = F,fontsize = 8,cellwidth = 15,cellheight = 2,annotation_row = ann_row)
